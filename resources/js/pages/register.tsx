    ...
    <div className="min-h-screen bg-gray-400">
      ...
      <main className="p-4 flex items-center justify-center min-h-[calc(100vh-56px)]">
        <div className="bg-white rounded-md p-6 w-full max-w-md">
          <h2 className="text-sm font-medium mb-4 text-center">Регистрация</h2>
          <form className="space-y-4">
            ...
            <div>
              <label className="block text-xs mb-1">Повторите пароль</label>
              <input type="password" className="w-full border border-gray-300 rounded p-2 text-xs" />
            </div>
            <div>
              <label className="block text-xs mb-1">Email (используется только для восстановления пароля)</label>
              <input type="email" className="w-full border border-gray-300 rounded p-2 text-xs" />
            </div>
